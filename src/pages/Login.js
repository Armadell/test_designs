    ...
    return (
        <>
            <section>
                ...
                <div class="min-w-screen min-h-screen  overflow:hidden bg-white flex items-center justify-center px-5 py-2 ">
                        ...
                        <div class="md:flex w-full">
                            ...
                            <div class="w-full md:w-1/2  py-10 px-5 md:px-10">
                                ...
                                <div>
                                    ...
                                    <div class="flex -mx-3">
                                        <div class="w-full px-3 mb-5">
                                            <button class="block w-full max-w-xs mx-auto bg-primary hover:bg-violet-600 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Log in</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
